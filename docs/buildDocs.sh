...
do
	...
	sphinx-apidoc -o docs/developer molsystem
...
<html>
   <head>
      <title>Documentation for the MolSystem plug-in for SEAMM</title>
   </head>
   <body>
      <h1>Documentation for the MolSystem plug-in for SEAMM</h1>
      <h2>Branches</h2>
      <ul>
EOF
